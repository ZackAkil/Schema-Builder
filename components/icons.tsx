...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    ...
    <path d="M4.5 4.5L6 2l1.5 2.5L10 6l-2.5 1.5L6 10l-1.5-2.5L2 6l2.5-1.5z"></path>
    <path d="M19.5 19.5L18 22l-1.5-2.5L14 18l2.5-1.5L18 14l1.5 2.5L22 18l-2.5 1.5z"></path>
  </svg>
);
